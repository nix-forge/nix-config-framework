...
contains consumer credentials, private paths, or generated secrets.
...
statement only after reviewing a dependency vulnerability against the
framework and supported source release scope. User-impacting issues belong in
