...
The latest `main` branch and the currently supported NixOS, nix-darwin, and
Home Manager toolchains receive security fixes. Older revisions are not
supported.

## Reporting a vulnerability

Do not open a public issue. Submit a report through
[GitHub private vulnerability reporting](https://github.com/nix-forge/nix-config-framework/security/advisories/new).
...
Please include the affected commit or version, the relevant module or host
